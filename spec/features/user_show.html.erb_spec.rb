...
RSpec.feature 'User show page', type: :feature do
  before do
    ...
    @first_post = Post.create(user: @first_user, title: 'The first post by Frank', text: 'The first content',
                              comment_counter: 1, like_counter: 8)
    @second_post = Post.create(user: @first_user, title: 'The second post', text: 'Number 2 content',
                               comment_counter: 2, like_counter: 7)
    @third_post = Post.create(user: @first_user, title: 'The third post', text: 'The third content',
                              comment_counter: 3, like_counter: 6)
    @fourth_post = Post.create(user: @first_user, title: 'The fourth post', text: 'My fourth content',
                               comment_counter: 4, like_counter: 5)
  ...
  scenario 'show redirects to the post detail page' do
    ...
    expect(page).to have_current_path(user_post_path(user_id: @first_user.id, id: @fourth_post.id))
  end
