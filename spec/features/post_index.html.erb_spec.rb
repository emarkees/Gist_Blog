...
RSpec.feature 'Post index page', type: :feature do
  before do
    ...
    @first_post = Post.create(user: @first_user, title: 'The first post',
                              text: 'Content for the first post', comment_counter: 0,
                              like_counter: 0)
    @second_post = Post.create(user: @first_user, title: 'The second post',
                               text: 'Content for the second post', comment_counter: 0,
                               like_counter: 4)
    @third_post = Post.create(user: @first_user, title: 'The third post',
                              text: 'Content for the third post', comment_counter: 0,
                              like_counter: 0)
    @fourth_post = Post.create(user: @first_user, title: 'The fourth  post',
                               text: 'Content for the fourth post', comment_counter: 0,
                               like_counter: 0)

    @first_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the first comment for first post')
    @second_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the second comment for first post')
    @third_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the third comment for first post')
    @fourth_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the fourth comment for first post')
    @fifth_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the fifth comment for first post')
    @sixth_comment = Comment.create(user_id: @first_user.id, post_id: @first_post.id, text: 'This the sixth comment for first post')
