...
**GIST BLOG** is a simple web app that where users can post a content. Likes and comments can be added to each post and saved into the database.
...
```sh
  git clone https://github.com/emarkees/Gist_Blog.git
```
...
- Linkedin: [@aAdeyemi oluolsa](https://linkedin.com/in/adeyemi-olusola)
...
Feel free to check the [issues page](https://github.com/emarkees/Gist_Blog/issues).
